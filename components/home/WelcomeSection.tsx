        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative w-full aspect-[4/3] rounded-2xl overflow-hidden shadow-xl">
            <Image
              ...
              alt="L.K. Machinery India Pvt. Ltd. Building"
              fill
          ...
          <div>
            ...
            >
              <span className="text-brand-red text-xl sm:text-2xl block mb-2 font-semibold tracking-wide">Welcome to —</span>
            ...
            <div className="grid grid-cols-2 gap-y-8 gap-x-6 mb-10 pb-10 border-b border-brand-dark/10">
              <div>
                <p className="font-heading text-brand-dark text-3xl lg:text-4xl mb-1">1979</p>
                <p className="text-brand-dark/60 text-xs font-body leading-tight">LK Group was founded in HK</p>
              </div>
              <div>
